...
describe('ProductService', () => {
  ...
  describe('create', () => {
    it('should create a new product by CreateProductDto', async () => {
      jest.spyOn(productsRepository, 'create').mockImplementation((createProductDto: CreateProductDto) => createProductEntity);
      jest.spyOn(productsRepository, 'save').mockImplementation(async (createProductEntity: Product) => createProductEntity);

      await expect(service.create(createProductDto)).resolves.toEqual(createProductEntity);
  ...
  describe('findAll', () => {
    it('should get an array of products', async () => {
      jest.spyOn(productsRepository, 'find').mockImplementation(async () => productEntities);
